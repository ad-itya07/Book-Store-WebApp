...
import { useGetStatsQuery } from '../../redux/features/admin/adminApi';
import Loading from '../../components/Loading';
import RevenueChart from '../../components/RevenueChart';

const AdminDashboard = () => {
  const {data: response = {} , isLoading, isError} = useGetStatsQuery()
    ...
    <>
      <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
        <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div>
            <span className="block text-2xl font-bold">{data?.totalBookCount}</span>
      ...
      <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
        ...
        <div className="row-span-3 bg-white shadow rounded-lg">
          ...
          {/* All person names and below numbers are static */}
