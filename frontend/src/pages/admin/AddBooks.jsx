...
import InputField from "../../components/AddBooksComponents/InputField";
import SelectField from "../../components/AddBooksComponents/SelectField";
...
const AddBook = () => {
  ...
  const onSubmit = async (data) => {
    ...
    newBookData.append("file", imageFile);
    try {
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="">
        ...
        <SelectField
          ...
          options={[
            ...
            { value: "Auto Biography", label: "Auto Biography"}
